...
const Customers = lazy(() => import("./services/Customers"));
const Vendors = lazy(() => import("./services/Vendors"));
const Categories = lazy(() => import("./services/Categories"));
const CustomerView = lazy(() => import("./services/Customers/CustomerView"));
const VendorView = lazy(() => import("./services/Vendors/VendorView"));
const SubCategory = lazy(() => import("./services/SubCategory")); 
const Product = lazy(() => import("./services/Products")); 
      ...
      <Switch>
        {!token ? (
          ...
          <>
            ...
            <Route exact path="/vendors/:id" component={VendorView} />
