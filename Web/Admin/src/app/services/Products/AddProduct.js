...
const AddProduct = ({
  ...
  const onAddProduct = async (values, setFieldValue) => {
    try {
      ...
      console.log("api err=", e.response.data.message);
    }
  };
                ...
                >
                          ...
                          {image.preview ? (
                            ...
                            <>
                              <img
                                ...
                                height="100"
                              />
                              <h5 className="text-center mt-2">Product Logo</h5>
                            </>
                          )}
                        </label>
                        <input
                  ...
                  <Modal.Footer className="d-flex justify-content-end">
                    <Button
                      ...
                      onClick={() => onAddProduct(values, setFieldValue)}
                    >
                      Add
                    </Button>
                  </Modal.Footer>
